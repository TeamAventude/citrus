    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Review a tools lifecycle events, analytics, and usability insights.</p>
        </div>
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-600">
                    ...
                    <div>
                      <span className="font-medium text-gray-700">Procured:</span> {moment(selectedTool!.procurementDate).format('MMM DD, YYYY')}
                    </div>
                    <div>
                    ...
                    <div>
                      <span className="font-medium text-gray-700">Last QC Result:</span>{' '}
                      {selectedTool!.lastQCPassed == null
                        ? 'N/A'
                        : selectedTool!.lastQCPassed
                          ? 'Pass'
                          : 'Fail'}
                    </div>
                    <div>
                      <span className="font-medium text-gray-700">Last QC Date:</span>{' '}
                      {selectedTool!.lastQCDate ? moment(selectedTool!.lastQCDate).format('MMM DD, YYYY') : 'N/A'}
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-12 text-center">
            {loading ? (
              ...
              <>
                ...
                <p className="text-gray-600">Choose a tool from the dropdown to view its timeline and analytics.</p>
              </>
            )}
          </div>
        )}
